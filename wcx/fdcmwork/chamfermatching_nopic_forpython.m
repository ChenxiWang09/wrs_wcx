...
function [partname,value]=chamfermatching_nopic_forpython(queryedgeaddress,j,x0,y0,x1,y1,times)
...
tempname=namelist_pgm(j).name;
templateEdgeMap=imread(strcat(Input_path, tempname));
%//==================================================================
